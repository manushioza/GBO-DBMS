...
public class JdbcOracleConnectionTemplate {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             * installation. xe is the sid, change according to what you setup during
             * installation.
             */
            ...
            // In your database, you should have a table created already with at least 1 row
            // of data. In this select query example, table testjdbc was already created
            // with at least 2 rows of data with columns NAME and NUM.
            // When you enter your data into the table, please make sure to commit your
            // insertions to ensure your table has the correct data. So the commands that
            // you need to type in Sqldeveloper are
            ...
            try (Statement stmt = conn1.createStatement()) {
                ...
                // If everything was entered correctly, this loop should print each row of data
                // in your TESTJDBC table.
